...
class UnetModule(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.example_input_array = torch.rand(1, self.hparams.in_chans, 256, 256, device=self.device)
...
class LamdaUnetModule(pl.LightningModule):
    def __init__(
        ...
        **kwargs):
        ...
        self.example_input_array = torch.rand(3, self.hparams.in_chans, 256, 256, device=self.device)
...
class DeepLabModule(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.model = DeepLab(
            num_input_chans=self.hparams.in_chans,
            num_classes=self.hparams.out_chans
        )
        self.example_input_array = torch.rand(1, self.hparams.in_chans, 256, 256, device=self.device)
...
class Unet3dModule(pl.LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.example_input_array = torch.rand(1, self.hparams.in_chans, 3, 256, 256, device=self.device)
